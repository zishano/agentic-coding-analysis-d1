...
# DB         = "/mnt/nvme1n1/data/lmk/PROJECT/agentic-coding-analysis-d1/tmp/requests.db"  # 损坏的数据库
DB         = "/mnt/nvme1n1/data/lmk/PROJECT/agentic-coding-analysis-d1/tmp/requests_fixed.db"  # 修复后的数据库

# JSONL 的一级目录的【父目录】：脚本会自动收集它下面所有直接子目录中“含 *.jsonl”的目录
JSONL_ROOT  = "/mnt/nvme1n1/data/lmk/PROJECT/agentic-coding-analysis-d1/tmp"
...
OUT_ROOT = "/mnt/nvme1n1/data/lmk/PROJECT/traces-d1"    # 每次运行生成其下 traces-<时间戳>/ 子目录
LOG_DIR  = "/mnt/nvme1n1/data/lmk/PROJECT/logs-d1"           # 日志目录(留空 "" = 不保留日志)，文件 run_<时间戳>.log
